    ...
    namespace restless
    {
        ...
        class Session
        {
            public:
                ...
                std::multimap< const std::string, const std::string > get_default_headers( void ) const;
                ...
                void set_deafult_headers( const std::multimap< const std::string, const std::string >& values );
